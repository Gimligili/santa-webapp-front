<script setup>
  ...
  const api_My_Admin_Groups_Url = `http://${ip}:${port}/api/group/admin`;     //GET
  const api_Delete_Group_Url = `http://${ip}:${port}/api/group/delete`;       //DELETE : request.get_json()['groupID']   
